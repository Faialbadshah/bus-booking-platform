  ...
  return (
    <section id="why" className="bg-canvas py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-[1fr_auto] md:items-end gap-6 mb-12 md:mb-14">
          <div>
          ...
          <p className="text-ink/45 text-base max-w-xs leading-relaxed">
            Not a chain. A specialist practice where cosmetic results are the only focus.
          </p>
        </div>
